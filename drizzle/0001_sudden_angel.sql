...
INSERT INTO `__new_tasks`("id", "title", "notes", "date_created", "date_completed", "due_date", "due_time", "user_id", "priority_category_id", "parent_task_id", "recurrence_rule", "sort_order") SELECT "id", "title", "notes", "date_created", "date_completed", "due_date", NULL, "user_id", "priority_category_id", "parent_task_id", "recurrence_rule", "sort_order" FROM `tasks`;--> statement-breakpoint
